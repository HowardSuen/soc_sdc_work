...
# row 12: common / ss_125 / u_pll_core_clk_o
set_clock_uncertainty -setup 0.12 [get_clocks {u_pll_core_clk_o}]
set_clock_uncertainty -hold 0.04 [get_clocks {u_pll_core_clk_o}]
