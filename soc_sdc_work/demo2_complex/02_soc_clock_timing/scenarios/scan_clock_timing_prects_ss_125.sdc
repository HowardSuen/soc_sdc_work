################################################################################
# Auto-generated SoC clock timing constraints for scenario: scan, stage: prects, corner: ss_125
...
# row 27: scan / ss_125 / top_scan_clk_pad
set_clock_uncertainty -setup 0.2 [get_clocks {top_scan_clk_pad}]
set_clock_uncertainty -hold 0.06 [get_clocks {top_scan_clk_pad}]
set_clock_latency -source -early 0.1 [get_clocks {top_scan_clk_pad}]
set_clock_latency -source -late 0.3 [get_clocks {top_scan_clk_pad}]
set_clock_latency -early 0.3 [get_clocks {top_scan_clk_pad}]
set_clock_latency -late 0.8 [get_clocks {top_scan_clk_pad}]
set_clock_transition -min 0.03 [get_clocks {top_scan_clk_pad}]
set_clock_transition -max 0.15 [get_clocks {top_scan_clk_pad}]
