...
# row 6: common / ss_125 / u_harden_a_clk_pll_o
set_clock_uncertainty -setup 0.12 [get_clocks {u_harden_a_clk_pll_o}]
set_clock_uncertainty -hold 0.04 [get_clocks {u_harden_a_clk_pll_o}]
